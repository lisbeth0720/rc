  ...
  export default {
    ...
    methods: {
      ...
      backTop(){ //回到顶部
        ...
        //2.scrollTo()是组件BetterScroll组件里的方法 （这种方式体现了封装思想，面对这个组件，而这个组件中有scrollTo这个方法，而scrollTo这个方法内部做了什么在这里不需要关心，只需要知道组件BetterScroll里有个scrollTo方法，面对这个组件进行开发就好。先把scrollTo事件封装到scrollTo方法里，再通过调用组件中的方法）
